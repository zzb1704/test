...
public class PageInterceptor implements Interceptor {
	...
	public Object intercept(Invocation invocation) throws Throwable {
		...
		if (obj != null) {
			System.out.println("PageInterceptor:obj=" + obj.getClass() + "|"
					+ obj);
			Pager<?> page = null;
			if (obj instanceof Pager<?>) {
				page = (Pager<?>) obj;
			} else if (obj instanceof ParamMap<?>) {
				ParamMap<?> params = (ParamMap<?>) obj;
...
//					System.out.println("key:"+key+",value:"+params.get(key));
				...
				page = (Pager<?>) ReflectUtil.getFieldValue(obj, "pager");
			}

			// if (obj instanceof Page<?>) {
			if (page != null) {
				System.out.println("to be page");
	...
	private void setTotalRecord(Object paramObject, Pager<?> page,
			MappedStatement mappedStatement, Connection connection) {
